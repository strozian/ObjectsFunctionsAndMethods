...
#                fill_color center_point radius
#
...
#            Keeps the window open until the user clicks incase you want the window to stay open longer or close quicker for more test runs
#
